...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/1639088097283.png"))); // NOI18N
...
public void validar(){
    ...
    if (TxtUser.getText().equals("")|| TxtPass.getText().equals("")) {
        JOptionPane.showMessageDialog(this,"Debe ingresar datos para poder acceder");
        TxtUser.requestFocus();
        
    } else {
        ven=vdao.ValidarVendedor(dni, user);
        if (ven.getUser()!=null && ven.getDni()!=null) {
            ...
            JOptionPane.showMessageDialog(this," Error debe ingresar un usuario valido");
            TxtUser.requestFocus();
        }
    }
